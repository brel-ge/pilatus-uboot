...
#define CONFIG_EXTRA_ENV_SETTINGS		\
  ...
  "fdt_file=" CONFIG_DEFAULT_FDT_FILE "\0" \
	...
	"mmcargs=setenv bootargs console=${console} " \
		"root=/dev/mmcblk${mmcblk}p${mmcpart} rootwait rw vt.global_cursor_default=0 fbcon=logo-pos:center,logo-count:1 ${cma_size} cma_name=linux,cma quiet\0 " \
